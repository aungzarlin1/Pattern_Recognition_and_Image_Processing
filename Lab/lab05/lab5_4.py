...
faceCascade = cv2.CascadeClassifier("otputs/Compass/classifier/cascade.xml")
...
while(True):
    ...
    for (x, y, w, h) in faces:
        ...
        cv2.putText(frame,'Compass', (x+10, y+h//2), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2, cv2.LINE_AA)
